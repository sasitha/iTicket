...
<html>
	<head>
		<title></title>
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('cssfiles/book.css'); ?>"></link>
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('cssfiles/notbook.css'); ?>"></link>
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('cssfiles/map.css'); ?>"></link>
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('cssfiles/pay_b.css'); ?>"></link>
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('cssfiles/juidate.css'); ?>"></link>
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('cssfiles/paydialog.css'); ?>"></link>
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('cssfiles/check_button.css'); ?>"></link>
